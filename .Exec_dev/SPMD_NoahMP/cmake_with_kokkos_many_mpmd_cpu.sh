...
cmake -G Ninja -DCMAKE_INSTALL_PREFIX:PATH=$ERF_INSTALL_DIR \
      -DMPIEXEC_PREFLAGS:STRING=--oversubscribe \
      -DCMAKE_BUILD_TYPE:STRING=Release \
      -DKokkos_UPDATE_PROVENANCE:BOOL=OFF \
      -DERF_DIM:STRING=3 \
      ...
      -DERF_ENABLE_NOAHMP_MPMD:BOOL=ON \
...
nice ninja -j 12 && nice ninja install -j 12
